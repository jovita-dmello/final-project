...
function makeChart(players) {
  ...
  var playerLabels = players.filter(d => d.YEAR==dat && d.STATE.toUpperCase() === stat).map(function(d) { return d.DISTRICT;});

  var weeksData = players.filter(d => d.YEAR==dat && d.STATE.toUpperCase() === stat).map(function(d) { return d.MURDER;});
