<?php
    if(isset($_POST['submit']))
    {
        ...
        $work_address=$station.', '.$station_street.', '.$station_city.', '.$station_district.', '.$station_state.', '.$station_pincode;
        ...
        if($password == $cpassword)
        {
            ...
            $reg="INSERT INTO admin_db(admin_id,password,fullname,gender,email,phone,home_address,work_address,aadharnum,police_id,account_status) VALUES('$username','$password','$fullname','$gender','$email','$mobile','$home_address','$work_address','$aadharnum','$police_id','Unverified')";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/Admin-reg.css">
    ...
    <section class="admin-form">
        <div class="container py-5 px-5">
            ...
            <form method="post" class="my-5">
                ...
                <label for="" class="form-label">Personal Address:</label>
                <div class="row py-2">
                ...
                <div class="row py-2">
                    <div class="col-lg-6">
                        ...
                        <input type="text" id="aadh" class="form-control" name="aadharnum" placeholder="ex : 1021-XXX-XXX-XX36" minlength="14" maxlength="14"  aria-label="" onfocusout="f1()">
                    </div> 
                    
                </div><br><br>

                <h3>Officer Details</h3><hr>
                <label for="" class="form-label">Station Address:</label>
                <div class="row py-2">    
                    <div class="form-group col-lg-6">
                        <input id="station" type="text" class="form-control" name="station" placeholder="Station Name/No:">
                    </div>  
                    <div class="form-group col-lg-6">                       
                        <input id="station-area" type="text" class="form-control" name="station-street" placeholder="Street/Area">
                    </div>
                </div>   
                <div class="row py-2">
                    <div class="form-group col-lg-6">
                        <input id="station-city" type="text" class="form-control" name="station-city" placeholder="City">
                    </div>  
                    <div class="form-group col-lg-6">
                        
                        <input id="station-pin" type="text" class="form-control" name="station-pincode" placeholder="PinCode">
                    </div>
                </div>
                <div class="row py-2">
                    <div class="form-group col-lg-6">
                        <input id="station-district" type="text" class="form-control" name="station-district" placeholder="District">
                    </div>  
                    <div class="form-group col-lg-6">
                        <select class="form-control py-1" aria-label="station-state" name="station-state">
                            <option selected disabled>States/Union Territorries</option>
                            <option disabled>States :</option>
                            <option value="Andhra Pradesh">Andhra Pradesh</option>
                            <option value="Arunachal Pradesh">Arunachal Pradesh</option>
                ...
                <div class="row py-2">
                    <div class="col-lg-6">
                        <label for="" class="form-label py-1">Police ID No:</label>
                        <input type="text" name="police_id" class="form-control" placeholder="ex : 20XX/XX/XX" aria-label="">
                    </div> 
