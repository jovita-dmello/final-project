...
if(isset($_POST['change-password'])){
  ...
  if ($newpass==$repass){
    $query="UPDATE admin_db SET password='$newpass' WHERE admin_id='$admin_id' AND password='$oldpass'";
...
if(isset($_POST['change-mob'])){
  ...
  $password=$_POST['pass'];
  $query1="UPDATE admin_db SET mobile=$number WHERE admin_id='$admin_id' AND password='$password' ";
    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pr-5" href="admin-home.php?id=<?php echo $admin_id;?>">Home<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown pr-5">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="admin_panel/admin-verification.php">Verify admin</a>
                  <a class="dropdown-item" href="admin_panel/complaint-approval.php">Complaint Approval</a>
                  <a class="dropdown-item" href="admin_panel/compl-status-updater.php">Complaint Status</a>
                </div>
            </li>
