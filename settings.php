...
if(isset($_POST['change-password'])){
  ...
  if ($newpass==$repass){
    $query="UPDATE admin_registration SET password='$newpass' WHERE username='$userid' AND password='$oldpass'";
...
if(isset($_POST['change-mob'])){
  ...
  $password=$_POST['pass'];
  $userid=$_POST['username'];
  $query1="UPDATE admin_registration SET mobile=$number WHERE username='$userid' AND password='$password' ";
