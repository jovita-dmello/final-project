...
if(isset($_POST['change-password'])){
  ...
  if ($newpass==$repass){
    $query="UPDATE user_db SET password='$newpass' WHERE user_id='$user_id' AND password='$oldpass'";
...
if(isset($_POST['change-mob'])){
  ...
  $password=$_POST['pass'];
  $query1="UPDATE user_db SET phone=$number WHERE user_id='$user_id' AND password='$password' ";
